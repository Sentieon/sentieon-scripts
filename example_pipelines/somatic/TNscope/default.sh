...
$SENTIEON_INSTALL_DIR/bin/sentieon driver -r $FASTA -t $NT -i tumor_deduped.bam -i normal_deduped.bam -q tumor_recal_data.table -q normal_recal_data.table --algo TNscope --tumor_sample $TUMOR_SM --normal_sample $NORMAL_SM --dbsnp $KNOWN_DBSNP output_tnscope.pre_filter.vcf.gz
