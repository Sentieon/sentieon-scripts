...
# samples with coverage between 50x and 100x
# using a matched paired Tumor+normal sample
# with fastq files named normal_1.fastq.gz,
# normal_2.fastq.gz, tumor_1.fastq.gz, tumor_2.fastq.gz
# *******************************************
...
START_DIR="$PWD/test/TNscope_midcov" #Determine where the output files will be stored
